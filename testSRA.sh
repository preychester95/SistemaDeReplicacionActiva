...
cd Prepare_scripts/
gnome-terminal --tab -e "node prepare_Replicas.js 5"
sleep 1
gnome-terminal --tab -e "node prepare_handlers.js 4"
sleep 1
cd ..
gnome-terminal --tab -e "node TO_module.js 5000"
sleep 1
cd Prepare_scripts/
gnome-terminal --tab -e "node prepare_RRs.js 4 9000"
sleep 1
gnome-terminal --tab -e "node prepare_clients.js 10"