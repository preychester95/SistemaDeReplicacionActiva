...
cd Prepare_scripts/
gnome-terminal --tab --title="Replicas" -e "node prepare_Replicas.js 3"
sleep 1
gnome-terminal --tab --title="Manejadores" -e "node prepare_handlers.js 10"
sleep 1
cd ..
gnome-terminal --tab --title="TotalOrder" -e "node TO_module.js 5000"
sleep 1
cd Prepare_scripts/
gnome-terminal --tab --title="RRs" -e "node prepare_RRs.js 30 9000"
sleep 1
