...
cd Prepare_scripts/
gnome-terminal --tab --title="Replicas" -e "node --no-deprecation prepare_Replicas.js 10 3000 false"
sleep 1
...
sleep 1
cd Prepare_scripts/
gnome-terminal --tab --title="RRs" -e "node --no-deprecation prepare_RRs.js 50 9000"
sleep 1
